# Exercise 7: Publish the applictaion via Application Gateway and Firewall (Optional)
...
1. On the **Basics** tab of **Create application gateway** page, enter the below instructions:
    ...
    - Application gateway name : Enter **gateway-DID (3)**
    ...
    - Subnet : Select **Manage subnet configuration (8)**

       ![application](media/updated7.png)
    
    - Under **Manage subnet configuration**, click on **+ Subnet (1)** and then enter name as **Subnet2 (2)** and click on **Save (3)**.

       ![application](media/updated8.png)

    - Navigate back to application gateway page select **Next : Frontends**      
...
1. Under **Add a backend pool** page, enter the below details:
    ...
    - Taget:Select **partsunlimited-web-DID(3)** .
    - Select **Add (4)**

      ![application](media/updated9.png)
